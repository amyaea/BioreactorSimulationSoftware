...
public class BioreactorSimulationProgram extends javax.swing.JFrame {
    ...
    private void runButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_runButtonActionPerformed
        ...
        finBioConTextField.setText(Double.toString(finBio)); //here
        
        //7.Final ethanol concentration
        double finEthanCon = P / waterVol;
        finEthConTextField.setText(Double.toString(finEthanCon)); //here
        
        //8.Calculate rate of ethanol Production
        double rateOfEthanol = finEthanCon / time;
        rateOfEthConTextField.setText(Double.toString(rateOfEthanol)); //here
        ...
        yieldOfEthTextField.setText(Double.toString(yield)); //here
        ...
        costOfSubTextField.setText(Double.toString(costSub)); //here

        //Revenue
        double revenue = P * waterVol * 1;
        revenueTextField.setText(Double.toString(revenue)); //here

        //Total production cost
        double totalProductCost = costSub + otherCost;
        totalProductionCostsTextField.setText(Double.toString(totalProductCost)); //here

        //Profit
        double profit = revenue-totalProductCost;
        profitTextField.setText(Double.toString(profit)); //here

        //Return on investment
        double ROI = (profit/sugarUsed)*100;
        returnOnInvestmentTextField.setText(Double.toString(ROI)); //here
