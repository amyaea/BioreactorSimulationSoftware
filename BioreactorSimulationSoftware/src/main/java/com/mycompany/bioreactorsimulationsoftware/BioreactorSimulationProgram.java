...
public class BioreactorSimulationProgram extends javax.swing.JFrame {
    ...
    private void runButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_runButtonActionPerformed
        ...
        f2.createPlot(Yxs, beta, time, Xmax, Xo, U); // this is the ethanol production per SPECIFIED UNIT of time
        f2.setVisible(true);
        
        
        SubConVSTime f3 = new SubConVSTime();
         
        f3.createPlot(Yxs, beta, time, Xmax, Xo, U, waterVol, iniSubCon); // this is the substrate consumption per SPECIFIED UNIT of time
        f3.setVisible(true);
