...
public class BioreactorSimulationProgram extends javax.swing.JFrame {
    ...
    private void runButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_runButtonActionPerformed
        ...
        final double Umax = 0.03*(Math.pow(N, 0.5)); //not a contant anymore
        ...
        double waterVol = Double.parseDouble(impSpeTextField.getText());
        ...
        double sugarUsed = (iniSubCon*0.9)*waterVol; // sugar used times broth volume
        ...
        //unit cost
        double totalCost = (sugarUsed*0.0005)+(Xo*0.02)+(2*time)+(10*time);
        String fN5 = String.format("%.3f", (totalCost/P));
        unitCost.setText(fN5);
        

        EthConVSTime f2 = new EthConVSTime();
         
        f2.createPlot((finEthanCon/(time*10)), time); // this is the ethanol concentration per SPECIFIED UNIT of time
        f2.setVisible(true);
        
        
        SubConVSTime f3 = new SubConVSTime();
         
        f3.createPlot((finSubCon/(time*10)), time); // this is the substrate concentration per SPECIFIED UNIT of time
        f3.setVisible(true);
        
        
        BioConVSTime f4 = new BioConVSTime();
         
        f4.createPlot((finBio/(time*10)), time); // this is the biomass concentration per SPECIFIED UNIT of time
        f4.setVisible(true);
