...
public class BioreactorSimulationProgram extends javax.swing.JFrame {
    ...
    private void runButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_runButtonActionPerformed
        ...
        f3.createPlot(Yxs, beta, time, Xmax, Xo, U, waterVol, iniSubCon); // this is the substrate concentration per SPECIFIED UNIT of time
        f3.setVisible(true);
        
        
        BioConVSTime f4 = new BioConVSTime();
         
        f4.createPlot(time, waterVol, Xmax, Xo, U); // this is the biomass concentration per SPECIFIED UNIT of time
        f4.setVisible(true);
