...
public class BioreactorSimulationProgram extends javax.swing.JFrame {
    ...
    public void runButtonActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        ...
        double U = Umax*(iniSubCon/(Ks+iniSubCon));
        ...
        double sugarConsumed = iniSubCon*0.9;
        //5.Estimate ethanol produced(P)
        double P = Yxs * X_t * beta * time;
        //6.Final Biomass concentration
        double finBio = X_t / waterVol;
        finBioConTextField.setText(Double.toString(finBio));
        //7.Final ethanol concentration
        double finEthalCon = P / waterVol;
        finEthConTextField.setText(Double.toString(finEthalCon));
        //8.Calculate rate of ethanol Production
        double rateOfEthalnol = finEthalCon / time;
        rateOfEthConTextField.setText(Double.toString(rateOfEthalnol));
        //9.Calculate substrate concentration
        double subConsumed = (180/92)*finEthalCon;
        double finSubCon = iniSubCon - subConsumed;
        //10.Calculate yield
        double yield = P/(iniSubCon - finSubCon);
        yieldOfEthTextField.setText(Double.toString(yield));
        //11.Final analysis
        //Convert Sub consumed from "g" to "kg" by dividing by 1000
        double convertSubConsumed = subConsumed/1000;
        //cost of substrate
        double costSub = subConsumed * 0.50;
        costOfSubTextField.setText(Double.toString(costSub));

        //Revenue
        double revenue = P * waterVol * 1;
        revenueTextField.setText(Double.toString(revenue));

        //Total production cost
        double totalProductCost = costSub * otherCost;
        totalProductionCostsTextField.setText(Double.toString(totalProductCost));
        ...
        double ROI = (profit/iniSubCon)*100;
        returnOnInvestmentTextField.setText(Double.toString(ROI));
    }
